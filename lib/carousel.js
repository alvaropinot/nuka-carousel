...
var reverseChildren = function reverseChildren(children, rtl) {
  return rtl ?
  // Create a new copy
  [].concat(_toConsumableArray(children)).reverse() : children;
};
...
var Carousel = (0, _createReactClass2.default)({
  ...
  render: function render() {
    ...
    var orderedChildren = reverseChildren(children, rtl);
    var formatedChildren = _react2.default.Children.count(orderedChildren) > 1 ? this.formatChildren(orderedChildren) : orderedChildren;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          { className: 'slider-list', dir: 'ltr', ref: 'list', style: this.getListStyles() },
          formatedChildren
        )
      ),
